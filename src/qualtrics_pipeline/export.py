...
def main() -> None:
    ...
    write_csv(
        ...
        [
            ...
            "is_open_text", "is_metadata", "is_sensitive", "is_text_entry_suffix", "parent_question_key",
            "parent_choice_code", "parent_choice_label", "text_reporting_mode", "response_labels",
        ],
    )
